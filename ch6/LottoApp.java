/*
Lotto App Εξάδες 1 - 49 με φίλτρα Ζητήστε από τον χρήστη να εισάγει έξι ακεραίους από 1 έως 49 και ελέγξτε αν αυτή η εξάδα περνάει από τα παρακάτω φίλτρα (predicates)
...
public class LottoApp {
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:/tmp/in.txt"));
             PrintStream ps = new PrintStream("C:/tmp/out.txt", StandardCharsets.UTF_8)) {
